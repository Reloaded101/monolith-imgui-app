...
namespace Weapons {
    const std::vector<Vec2> AK_PATTERN = {
    ...
    const std::vector<Vec2> MP5_PATTERN = {
    ...
    const std::vector<Vec2> CUSTOM_SMG_PATTERN = {
    ...
    const std::vector<Vec2> LR300_PATTERN = {
    ...
    const std::vector<Vec2> THOMPSON_PATTERN = {
    ...
    const std::vector<Vec2> HMLMG_PATTERN(60, Vec2(0, -1.4));
    const std::vector<Vec2> M249_PATTERN(100, Vec2(0, -1.49));
    const std::vector<Vec2> SEMI_PATTERN = {{0, -1.4}};
    const std::vector<Vec2> REVOLVER_PATTERN = {{0, -1.7}};
    const std::vector<Vec2> SEMI_PISTOL_PATTERN = {{0, -0.95}};
    const std::vector<Vec2> M92_PATTERN = {{0, -3}};
    const std::vector<Vec2> M39_PATTERN = {{0.9, -1.6}};
    const std::vector<Vec2> PYTHON_PATTERN = {{0, -5.8}};
    const std::vector<Vec2> NAILGUN_PATTERN = {{0.2, -2.1}};

    const std::vector<Weapon> ALL_WEAPONS = {
        {"AK-47", AK_PATTERN, 133.3f},
        {"MP5", MP5_PATTERN, 100.0f},
        {"Custom SMG", CUSTOM_SMG_PATTERN, 90.0f},
        {"LR-300", LR300_PATTERN, 120.0f},
        {"Thompson", THOMPSON_PATTERN, 90.0f},
        {"HMLMG", HMLMG_PATTERN, 100.0f},
        {"M249", M249_PATTERN, 100.0f},
        {"Semi Auto Rifle", SEMI_PATTERN, 175.0f},
        {"Revolver", REVOLVER_PATTERN, 175.0f},
        {"Semi Auto Pistol", SEMI_PISTOL_PATTERN, 150.0f},
        {"M92", M92_PATTERN, 150.0f},
        {"M39", M39_PATTERN, 175.0f},
        {"Python", PYTHON_PATTERN, 150.0f},
        {"Nail Gun", NAILGUN_PATTERN, 150.0f}
    };
}
